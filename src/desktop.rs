        ...
        egui::CentralPanel::default().show(ctx, |ui| {
            ...
            ui.horizontal(|ui| {
                ...
                if ui.button("Export PNG").clicked() {
                    ...
                    if self.exporter.export_density_png(&self.simulation, path).is_ok() {
            ...
            ui.horizontal(|ui| {
                ...
                ui.add(egui::Slider::new(&mut self.diffusion_strength, 0.00000001..=0.00001).text("Diffusion"));
            });
            ...
            ui.horizontal(|ui| {
                ...
                ui.radio_value(&mut self.flow_pattern, FlowPattern::Horizontal, "Horizontal");
            ...
            ui.horizontal(|ui| {
                ...
                ui.label(format!("→ ({:.1}°, {:.1}°)", arrow_x * 90.0, arrow_y * 90.0));
            });
            ...
            if response.dragged() || response.clicked() {
                if let Some(pos) = response.interact_pointer_pos() {
                    ...
                    if x < self.simulation.width && y < self.simulation.height {
                        ...
                        self.simulation.add_velocity(x, y, glam::Vec2::new(vel_x, vel_y));
                    }
                }
            }
            ...
            ui.label(format!("Frame: {} | Click/drag to add fluid | Cell Size: {:.1}", 
...
impl DesktopApp {
    fn add_velocity_pattern(&mut self, x: usize, y: usize) {
        ...
        match self.flow_pattern {
            FlowPattern::Upward => {
                self.simulation.add_velocity(x, y, glam::Vec2::new(0.0, -strength));
            }
            ...
            FlowPattern::Horizontal => {
                self.simulation.add_velocity(x, y, glam::Vec2::new(strength, 0.0));
            }
            FlowPattern::Radial => {
        ...
        self.simulation.add_velocity(x, y, glam::Vec2::new(proj_x, proj_y));
    }
}